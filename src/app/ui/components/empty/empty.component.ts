...
import { type ZardIcon } from '@ui/components/icon/icons';
import { ZardStringTemplateOutletDirective } from '@ui/core/directives/string-template-outlet/string-template-outlet.directive';
