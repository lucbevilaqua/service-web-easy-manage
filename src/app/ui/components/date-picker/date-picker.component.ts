...
import { ChangeDetectionStrategy, Component, computed, forwardRef, inject, input, model, output, type TemplateRef, viewChild, ViewEncapsulation } from '@angular/core';

import { mergeClasses } from 'src/app/ui/utils/merge-classes';
import { datePickerVariants, type ZardDatePickerVariants } from './date-picker.variants';

import type { ClassValue } from 'clsx';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';
import { ZardButtonComponent, ZardCalendarComponent, ZardPopoverComponent, ZardPopoverDirective, ZardIconComponent } from '@ui/components';
...
export class ZardDatePickerComponent implements ControlValueAccessor {
  ...
  protected readonly buttonClasses = computed(() => {
    ...
    return mergeClasses('justify-start text-left font-normal w-full', !hasValue && 'text-muted-foreground', height, 'min-w-[240px]');
  });
